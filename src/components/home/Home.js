  ...
  return (
    <>
      <div className="homepage">
        <div className="image">
          <img src="https://c4.wallpaperflare.com/wallpaper/792/460/915/1920x1080-px-code-coding-programming-simple-background-anime-ah-my-goddess-hd-art-wallpaper-preview.jpg"></img>
        </div>
        ...
        <div className="articles2">
          <img
            className="separator"
            src="https://f8n-production.s3.amazonaws.com/creators/profile/4ktswexoz-original-jpeg-at5v8d.jpeg"
          ></img>
          <div className="art2">
            <p>Nisi consectetur officia in excepteur aute ut. Magna qui minim
            occaecat amet duis minim sit ipsum occaecat qui mollit. Sunt laboris
            esse aliqua amet adipisicing cupidatat occaecat excepteur pariatur
            commodo. Lorem consectetur dolore ullamco commodo cupidatat.Irure
            voluptate est ea est ut est incididunt dolor sit fugiat occaecat.
            Sit pariatur amet incididunt enim. Qui veniam eu esse qui nisi esse
            aliquip occaecat irure sint. Proident irure pariatur ipsum laboris
            eu sunt ut nostrud magna proident.Voluptate proident in dolor non
            occaecat. Consequat laborum deserunt et mollit Lorem aliquip amet
            proident culpa labore. Eiusmod exercitation elit ullamco eiusmod
            esse qui aute exercitation eu. Et dolor cupidatat duis enim eiusmod
            sunt. Eiusmod proident amet et ad pariatur magna officia tempor.Ex
            ex Lorem veniam eu reprehenderit sint cillum eiusmod et ipsum
            ullamco ipsum. Nulla non occaecat irure amet adipisicing qui qui.
            Cillum ex irure ipsum dolor nostrud...</p>
            <img
